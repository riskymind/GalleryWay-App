...
import com.asterisk.gallerywayapp.databinding.UnsplashPhotoLoadStateFooterBinding

class UnSplashPhotoLoadStateFooter(private val retry: () -> Unit) : LoadStateAdapter<UnSplashPhotoLoadStateFooter.LoadStateViewHolder>() {
